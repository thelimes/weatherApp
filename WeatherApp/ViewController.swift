...
//                    print (json)
//                    let array:NSArray = json["weather"] as! NSArray
//                    let firstData:NSDictionary = array[0] as! NSDictionary
//                    
                    ...
                    let mainDescr = ((json["weather"]! as! NSArray)[0] as! NSDictionary)["description"] {
                        ...
                        let timeOfSunRise = NSTimeInterval(sunrise + 120)
                        ...
                        let timeOfSunset = NSTimeInterval(sunset + 120)
